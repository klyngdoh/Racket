...
(define (initial-world speed)
  (make-world (make-ball 330 384 0 0) (make-racket 330 384 0 0 #false 0 0)
...
;;                                         (make-racket 250 250 5 -5 #false 0 0)
;;                                          RALLY 0 1)) => #true
  ...
  (make-world
   ...
   (if (get-racket-selected? w)
       ...
       (make-racket (+ (get-racket-x w) (get-racket-vx w))
                ...
                (get-racket-selected? w) (get-racket-dx w) (get-racket-dy w)))
...
(define (racket-collide-left w)
  (make-world
   ...
   (make-racket (floor (/ RACKET-LENGTH 2)) (get-racket-y w) 0
                (get-racket-vy w) (get-racket-selected? w)
...
(define (world-to-scene w)
  (if (racket-selected? (world-racket w))
      (place-images (list BALL-IMAGE RACKET-IMAGE CURSOR-IMAGE)
                    (list (make-posn (get-ball-x w) (get-ball-y w))
                          (make-posn (get-racket-x w) (get-racket-y w))
                          (make-posn (+ (get-racket-x w) (get-racket-dx w))
                                     (+ (get-racket-y w) (get-racket-dy w))))
                    (draw-court w))
...
does not bounce off the right wall")
  ...
  (check-equal? (ball-collide-wall (make-world (make-ball 250 10 10 -30)
                ...
                (make-world (make-ball 260 20 10 30)
                            (make-racket 250 250 0 0 #false
                                         0 0) RALLY 0 1) "The
ball bounces off the front wall")
...
does not bounce off the front wall")
  ...
  (check-equal? (ball-hits-back? (make-world (make-ball 250 645 10 10)
                                             (make-racket 250 250 10 10 #false
                                                          0 0)
                                             RALLY 0 1)) #true "The ball
hits the front wall")
...
does not hit the left wall")
  ...
  (check-equal? (racket-collide-wall (make-world (make-ball 250 250 1 1)
                                                 (make-racket 40 300 -20 0
                                                              #false 0 0)
                                                 RALLY 0 1))
                (make-world (make-ball 251 251 1 1)
                            (make-racket 23 300 0 0 #false 0 0)
...
does not hit the right wall")
  ...
  (check-equal? (racket-collide-wall (make-world (make-ball 250 250 1 1)
                                                 ...
                                                 RALLY 0 1))
                (make-world (make-ball 251 251 1 1)
                            (make-racket 402 300 0 0 #false 0 0)
...
initial state")
  ...
  (check-equal? (world-after-no-collision (make-world (make-ball 200 200 0 0)
                                                      (make-racket 300 300 0 0
                                                                   #true 0 0)
                                                      RALLY 0 1))
                (make-world (make-ball 200 200 0 0)
                            (make-racket 300 300 0 0 #true 0 0)
                            RALLY 0 1) "They should be the same")

  (check-equal? (world-after-mouse-event (make-world (make-ball 250 250 0 0)
                                                     (make-racket 300 300 0 0
                                                                  #true 0 0)
                                                     RALLY 0 1)
                                         300 300 "button-up")
  ...
  (check-equal? (world-to-scene (make-world (make-ball 250 250 0 0)
                                            (make-racket 300 300 0 0
                                                         #true 15 15)
                                            RALLY 0 1))
                (place-images (list (circle 3 "solid" "black")
